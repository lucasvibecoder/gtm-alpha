...
## Section 4b: Pre-Send QA Protocol
...
**BATCH TIER** (e.g., Bid Radar Brief — same deliverable for a geography/segment)
...
**TEMPLATE + ENRICH TIER** (e.g., Estimator Capacity Audit — 80% template, 20% per-prospect)
...
**CUSTOM TIER** (e.g., Portfolio Estimating Benchmark — deep per-prospect research)
...
### Verification Ledger Check (if present)

If the PVP was generated by Module 3B and includes a Verification Ledger:
...
| [X min] | **Pre-Send QA** — run Section 4b checklist for each PVP tier before any send goes out | Browser + PVP file |
